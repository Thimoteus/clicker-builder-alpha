...
(function(exports) {
  ...
  var prettyNumber = new Pretty(function (n) {
      ...
      throw new Error("Failed pattern match at Types.Class line 26, column 1 - line 50, column 1: " + [ n.constructor.name ]);
  });
  ...
  exports["prettyInt"] = prettyInt;;
 
})(PS["Types.Class"] = PS["Types.Class"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  var Types_Class = PS["Types.Class"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];     
  ...
  var serializePopulation = new Types_Class.Serialize(function (v) {
      return Types_Class.serialize(Types_Class.serializeNumber)(v);
  });
  var serializeClicks = new Types_Class.Serialize(function (v) {
      return Types_Class.serialize(Types_Class.serializeNumber)(v);
  });
  var semiringPopulation = new Prelude.Semiring(function (v) {
      return function (v1) {
          return v + v1;
      };
  }, function (v) {
  ...
  var prettyPopulation = new Types_Class.Pretty(function (v) {
      return Types_Class.prettify(Types_Class.prettyNumber)(v) + " Clickonians";
  });
  var prettyClicksPerSecond = new Types_Class.Pretty(function (v) {
      return Types_Class.prettify(Types_Class.prettyNumber)(v) + " cps";
  });
  var prettyClicks = new Types_Class.Pretty(function (v) {
      return Types_Class.prettify(Types_Class.prettyNumber)(v) + " c";
  });
  ...
  var clicksToPop = Unsafe_Coerce.unsafeCoerce;
  exports["Population"] = Population;
  exports["Clicks"] = Clicks;
  exports["clicksToPop"] = clicksToPop;
  ...
  exports["serializePopulation"] = serializePopulation;
  exports["semiringPopulation"] = semiringPopulation;;
 
})(PS["Types.Numbers"] = PS["Types.Numbers"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var serializeUpgrade = new Types_Class.Serialize(function (v) {
      if (v instanceof Misc1) {
          return Types_Class.serialize(Types_Class.serializeInt)(v.value0);
      };
      ...
      throw new Error("Failed pattern match at Types.Upgrades line 67, column 1 - line 79, column 1: " + [ v.constructor.name ]);
  });
  var serializeUpgrades = new Types_Class.Serialize(function (v) {
      return "{ \"misc1\": " + (Types_Class.serialize(serializeUpgrade)(v.misc1) + (", \"misc2\": " + (Types_Class.serialize(serializeUpgrade)(v.misc2) + (", \"tech1\": " + (Types_Class.serialize(serializeUpgrade)(v.tech1) + (", \"tech2\": " + (Types_Class.serialize(serializeUpgrade)(v.tech2) + (", \"phil1\": " + (Types_Class.serialize(serializeUpgrade)(v.phil1) + (", \"phil2\": " + (Types_Class.serialize(serializeUpgrade)(v.phil2) + (", \"poli1\": " + (Types_Class.serialize(serializeUpgrade)(v.poli1) + (", \"poli2\": " + (Types_Class.serialize(serializeUpgrade)(v.poli2) + (", \"science1\": " + (Types_Class.serialize(serializeUpgrade)(v.science1) + (", \"science2\": " + (Types_Class.serialize(serializeUpgrade)(v.science2) + "}")))))))))))))))))));
  });
...
})(PS["Types.Upgrades"] = PS["Types.Upgrades"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];     
  var Disaster1 = (function () {
      function Disaster1() {

      };
      Disaster1.value = new Disaster1();
      return Disaster1;
  })();
  exports["Disaster1"] = Disaster1;;
 
})(PS["Types.Disaster"] = PS["Types.Disaster"] || {});
(function(exports) {
  // module Types.Age
...
})(PS["Types.Age"] = PS["Types.Age"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var $foreign = PS["Types.Age"];
  var Prelude = PS["Prelude"];
  var Types_Class = PS["Types.Class"];
  var Types_Numbers = PS["Types.Numbers"];
  var Data_Foldable = PS["Data.Foldable"];
  var Data_Monoid = PS["Data.Monoid"];     
  var BronzeS = (function () {
      function BronzeS(value0) {
          this.value0 = value0;
      };
      BronzeS.create = function (value0) {
          return new BronzeS(value0);
      };
      return BronzeS;
  })();
  var NoAgeState = (function () {
      function NoAgeState() {

      };
      NoAgeState.value = new NoAgeState();
      return NoAgeState;
  })();
  var Stone = (function () {
      function Stone() {
  ...
  var Philosophical = (function () {
      function Philosophical() {

      };
      Philosophical.value = new Philosophical();
  ...
  var Wonders = (function () {
      function Wonders() {

      };
      Wonders.value = new Wonders();
      return Wonders;
  })();
  var Holy = (function () {
      function Holy() {
  ...
  var Draconic = (function () {
      function Draconic() {

      };
      Draconic.value = new Draconic();
      return Draconic;
  })();
  var Dark = (function () {
      function Dark() {
  ...
  var Alchemical = (function () {
      function Alchemical() {

      };
      Alchemical.value = new Alchemical();
      return Alchemical;
  })();
  ...
  var Interstellar = (function () {
      ...
      Interstellar.value = new Interstellar();
      return Interstellar;
  })();                 
  var serializeAgeState = new Types_Class.Serialize(function (v) {
      if (v instanceof NoAgeState) {
          return "";
      };
      if (v instanceof BronzeS) {
          return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(",")([ Types_Class.serialize(Types_Numbers.serializePopulation)(v.value0.population), Types_Class.serialize(Types_Class.serializeInt)(v.value0.disasterStack), Types_Class.serialize(Types_Class.serializeInt)(v.value0.stackRemoval) ]);
      };
      throw new Error("Failed pattern match at Types.Age line 69, column 1 - line 77, column 1: " + [ v.constructor.name ]);
  });
  var ageShow = new Prelude.Show(function (v) {
      ...
      if (v instanceof Heroic) {
          return "Heroic";
      };
      if (v instanceof Iron) {
          return "Iron";
      };
      if (v instanceof Philosophical) {
          return "Philosophical";
      };
      if (v instanceof Classical) {
          return "Classical";
      };
      if (v instanceof Wonders) {
          return "Wonders";
      };
      if (v instanceof Holy) {
          return "Holy";
      };
      ...
      if (v instanceof Alchemical) {
          return "Alchemical";
      };
      if (v instanceof Renaissance) {
          return "Renaissance";
      };
      if (v instanceof Piracy) {
          return "Piracy";
      };
      ...
      if (v instanceof Interstellar) {
          return "Interstellar";
      };
      throw new Error("Failed pattern match at Types.Age line 32, column 1 - line 56, column 1: " + [ v.constructor.name ]);
  });                                                           
  var serializeAge = new Types_Class.Serialize(Prelude.show(ageShow));
  exports["BronzeS"] = BronzeS;
  exports["NoAgeState"] = NoAgeState;
  exports["Stone"] = Stone;
  exports["Bronze"] = Bronze;
  exports["Heroic"] = Heroic;
  exports["Iron"] = Iron;
  exports["Philosophical"] = Philosophical;
  exports["Classical"] = Classical;
  exports["Wonders"] = Wonders;
  exports["Holy"] = Holy;
  exports["Draconic"] = Draconic;
  exports["Dark"] = Dark;
  exports["Medieval"] = Medieval;
  exports["Alchemical"] = Alchemical;
  exports["Renaissance"] = Renaissance;
  exports["Piracy"] = Piracy;
  ...
  exports["Space"] = Space;
  exports["Solar"] = Solar;
  exports["Interstellar"] = Interstellar;
  exports["ageShow"] = ageShow;
  exports["serializeAge"] = serializeAge;
  exports["serializeAgeState"] = serializeAgeState;
  exports["unsafeBronze"] = $foreign.unsafeBronze;;
...
(function(exports) {
  ...
  var Types_Class = PS["Types.Class"];
  var Types_Numbers = PS["Types.Numbers"];
  var Types_Upgrades = PS["Types.Upgrades"];
  var Types_Disaster = PS["Types.Disaster"];
  var Types_Age = PS["Types.Age"];     
  ...
  var welcomeMessage = "";
  var showView = new Prelude.Show(function (v) {
      if (v instanceof UpgradesTab) {
          return "Developments";
      };
      if (v instanceof AdvanceTab) {
          return "Advance";
      };
      if (v instanceof PopulationTab) {
          return "Population";
      };
      if (v instanceof HeroesTab) {
          return "Heroes";
      };
      if (v instanceof TechTreeTab) {
          return "Tech Tree";
      };
      throw new Error("Failed pattern match at Types line 65, column 1 - line 72, column 1: " + [ v.constructor.name ]);
  });
  var initialState = {
      currentClicks: 0.0, 
      totalClicks: 0.0, 
      cps: 0.0, 
      age: Types_Age.Stone.value, 
      ageState: Types_Age.NoAgeState.value, 
      burst: 1.0, 
      upgrades: Types_Upgrades.initialUpgrades, 
...
(function(exports) {
  ...
  var Types = PS["Types"];
  var Types_Age = PS["Types.Age"];     
  var nextAge = function (v) {
      if (v instanceof Types_Age.Stone) {
          return Types_Age.Bronze.value;
      };
      if (v instanceof Types_Age.Bronze) {
          return Types_Age.Iron.value;
      };
      if (v instanceof Types_Age.Iron) {
          return Types_Age.Classical.value;
      };
      if (v instanceof Types_Age.Classical) {
          return Types_Age.Dark.value;
      };
      if (v instanceof Types_Age.Dark) {
          return Types_Age.Medieval.value;
      };
      if (v instanceof Types_Age.Medieval) {
          return Types_Age.Renaissance.value;
      };
      if (v instanceof Types_Age.Renaissance) {
          return Types_Age.Imperial.value;
      };
      if (v instanceof Types_Age.Imperial) {
          return Types_Age.Industrial.value;
      };
      if (v instanceof Types_Age.Industrial) {
          return Types_Age.Nuclear.value;
      };
      if (v instanceof Types_Age.Nuclear) {
          return Types_Age.Information.value;
      };
      if (v instanceof Types_Age.Information) {
          return Types_Age.Global.value;
      };
      if (v instanceof Types_Age.Global) {
          return Types_Age.Space.value;
      };
      return Types_Age.Solar.value;
  };
...
(function(exports) {
  ...
  var viewLevel = (function () {
      var viewLevel$prime = function (v) {
          if (v instanceof Types_Upgrades.Misc1) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Misc2) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Tech1) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Tech2) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Phil1) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Phil2) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Poli1) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Poli2) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Science1) {
              return v.value0;
          };
          if (v instanceof Types_Upgrades.Science2) {
              return v.value0;
          };
          throw new Error("Failed pattern match at Lenses line 90, column 5 - line 91, column 5: " + [ v.constructor.name ]);
      };
  ...
  var science1 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($164) {
          return (function (v) {
              return v.science1;
          })(runUpgrades($164));
      })(function (v) {
  ...
  var science2 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($165) {
          return (function (v) {
              return v.science2;
          })(runUpgrades($165));
      })(function (v) {
  ...
  var tech1 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($166) {
          return (function (v) {
              return v.tech1;
          })(runUpgrades($166));
      })(function (v) {
  ...
  var tech2 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($167) {
          return (function (v) {
              return v.tech2;
          })(runUpgrades($167));
      })(function (v) {
  ...
  var poli2 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($168) {
          return (function (v) {
              return v.poli2;
          })(runUpgrades($168));
      })(function (v) {
  ...
  var poli1 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($169) {
          return (function (v) {
              return v.poli1;
          })(runUpgrades($169));
      })(function (v) {
  ...
  var phil2 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($170) {
          return (function (v) {
              return v.phil2;
          })(runUpgrades($170));
      })(function (v) {
  ...
  var phil1 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($171) {
          return (function (v) {
              return v.phil1;
          })(runUpgrades($171));
      })(function (v) {
  ...
  var misc2 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($172) {
          return (function (v) {
              return v.misc2;
          })(runUpgrades($172));
      })(function (v) {
  ...
  var misc1 = function (dictStrong) {
      return Data_Lens_Lens.lens(function ($173) {
          return (function (v) {
              return v.misc1;
          })(runUpgrades($173));
      })(function (v) {
  ...
  var cpsNumber = function (dictStrong) {
      return function ($174) {
          return cps(dictStrong)(clicksPerSecond(dictStrong)($174));
      };
  };
  ...
  var currentClicksNumber = function (dictStrong) {
      return function ($175) {
          return currentClicks(dictStrong)(clicks(dictStrong)($175));
      };
  };
  var totalClicksNumber = function (dictStrong) {
      return function ($176) {
          return totalClicks(dictStrong)(clicks(dictStrong)($176));
      };
  };
  ...
  var burstNumber = function (dictStrong) {
      return function ($177) {
          return burst(dictStrong)(clicks(dictStrong)($177));
      };
  };
  var bronzeState = function (dictChoice) {
      var f = function (v) {
          if (v instanceof Types_Age.BronzeS) {
              return new Data_Maybe.Just(v.value0);
          };
          return Data_Maybe.Nothing.value;
      };
      return Data_Lens_Prism["prism'"](Types_Age.BronzeS.create)(f)(dictChoice);
  };
  var bronzeStack = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.disasterStack;
      })(function (v) {
          return function (v1) {
              var $156 = {};
              for (var $157 in v) {
                  if (v.hasOwnProperty($157)) {
                      $156[$157] = v[$157];
                  };
              };
              $156.disasterStack = v1;
              return $156;
          };
      })(dictStrong);
  };
  var bronzePop = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.population;
      })(function (v) {
          return function (v1) {
  ...
  var ageState = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.ageState;
      })(function (v) {
          return function (v1) {
  ...
  exports["bronzeStack"] = bronzeStack;
  exports["bronzePop"] = bronzePop;
  exports["bronzeState"] = bronzeState;
  exports["ageState"] = ageState;
...
(function(exports) {
  ...
  var Data_Const = PS["Data.Const"];
  var Data_Maybe_First = PS["Data.Maybe.First"];     
  var isSuffering = function (state) {
      var $2 = Data_Lens_Fold["^?"](state.ageState)(function ($4) {
          return Lenses.bronzeState(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_Maybe_First.monoidFirst)))(Lenses.bronzeStack(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($4));
      });
      ...
      throw new Error("Failed pattern match at Age.Bronze line 14, column 1 - line 15, column 1: " + [ $2.constructor.name ]);
  };
  var getBronzeState = function (dictUnsafeBronze) {
      return function ($5) {
          return Data_Maybe_Unsafe.fromJust(Data_Lens_Fold.preview(Lenses.bronzeState(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_Maybe_First.monoidFirst))))((function (v) {
              return v.ageState;
          })($5)));
      };
  };
  exports["isSuffering"] = isSuffering;
  exports["getBronzeState"] = getBronzeState;;
 
})(PS["Age.Bronze"] = PS["Age.Bronze"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
...
(function(exports) {
  ...
  var Data_Maybe = PS["Data.Maybe"];
  var Data_Lens = PS["Data.Lens"];
  var Age_Bronze = PS["Age.Bronze"];
  var Data_Lens_Setter = PS["Data.Lens.Setter"];
  var Data_Profunctor_Strong = PS["Data.Profunctor.Strong"];
  var Data_Profunctor_Choice = PS["Data.Profunctor.Choice"];
  var Types_Age = PS["Types.Age"];
  var Types_Numbers = PS["Types.Numbers"];     
  var stopSuffering = Data_Lens_Setter[".~"](function ($10) {
      return Lenses.ageState(Data_Profunctor_Strong.strongFn)(Lenses.bronzeState(Data_Profunctor_Choice.choiceFn)(Lenses.bronzeStack(Data_Profunctor_Strong.strongFn)($10)));
  })(0);
  var lowerSuffering = function (state) {
      return Data_Lens_Setter["-~"](Prelude.ringInt)(function ($11) {
          return Lenses.ageState(Data_Profunctor_Strong.strongFn)(Lenses.bronzeState(Data_Profunctor_Choice.choiceFn)(Lenses.bronzeStack(Data_Profunctor_Strong.strongFn)($11)));
      })((function (v) {
          return v.stackRemoval;
      })(Types_Age.unsafeBronze(function (dictUnsafeBronze) {
          return Age_Bronze.getBronzeState(dictUnsafeBronze);
      })(state)))(state);
  };
  var soothe = function (state) {
      var n = (function (v) {
          return v.disasterStack;
      })(Types_Age.unsafeBronze(function (dictUnsafeBronze) {
          return Age_Bronze.getBronzeState(dictUnsafeBronze);
      ...
      var $7 = n <= 0;
      if ($7) {
          return stopSuffering(state);
      };
      if (!$7) {
          return lowerSuffering(state);
      };
      throw new Error("Failed pattern match at Age.Bronze.Eval line 23, column 1 - line 24, column 1: " + [ $7.constructor.name ]);
  };
  var increasePopulation = function (state) {
      return Data_Lens_Setter["+~"](Types_Numbers.semiringPopulation)(function ($12) {
          return Lenses.ageState(Data_Profunctor_Strong.strongFn)(Lenses.bronzeState(Data_Profunctor_Choice.choiceFn)(Lenses.bronzePop(Data_Profunctor_Strong.strongFn)($12)));
      })(Types_Numbers.clicksToPop(state.burst))(state);
  };
  var evalClick = function (state) {
      if (Age_Bronze.isSuffering(state)) {
          return soothe(state);
      };
      if (Prelude.otherwise) {
          return increasePopulation(state);
      };
      throw new Error("Failed pattern match at Age.Bronze.Eval line 18, column 1 - line 19, column 1: " + [ state.constructor.name ]);
  };
  var autoclick = function (ms) {
      return function (state) {
          ...
          var perSecond = function (v) {
              return $$Math.log($$Math.log(v / 10.0 + 1.0)) + 1.0;
          };
          return Data_Lens_Setter["+~"](Types_Numbers.semiringClicks)(Lenses.currentClicks(Data_Profunctor_Strong.strongFn))(perSecond(pop))(state);
      };
  };
  exports["autoclick"] = autoclick;
  exports["evalClick"] = evalClick;;
 
})(PS["Age.Bronze.Eval"] = PS["Age.Bronze.Eval"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
...
(function(exports) {
  ...
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  var Halogen_HTML = PS["Halogen.HTML"];     
  var theButton = Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.id_("clicker-wrapper") ])([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Events_Indexed.onMouseDown(Halogen_HTML_Events.input_(Types.Click.create)), Halogen_HTML_Properties_Indexed.id_("the-button") ])([ Halogen_HTML_Elements_Indexed.a([ Halogen_HTML_Properties_Indexed.href("#") ])([ Halogen_HTML_Elements_Indexed.i([ Util.mkClass("fa fa-hand-pointer-o") ])([  ]) ]) ]) ]);
  var sideLabel = function (str) {
      return Halogen_HTML_Elements_Indexed.p([ Util.mkClass("label") ])([ Halogen_HTML.text(str) ]);
  };
  exports["theButton"] = theButton;
  exports["sideLabel"] = sideLabel;;
 
})(PS["Render.Side"] = PS["Render.Side"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Data_Maybe = PS["Data.Maybe"];
  var Data_Lens = PS["Data.Lens"];
  var Render_Side = PS["Render.Side"];
  var Age_Bronze = PS["Age.Bronze"];
  var Halogen = PS["Halogen"];
  var Halogen_HTML_Indexed = PS["Halogen.HTML.Indexed"];
  var Halogen_HTML_Elements_Indexed = PS["Halogen.HTML.Elements.Indexed"];
  ...
  var Data_Const = PS["Data.Const"];
  var Data_Maybe_First = PS["Data.Maybe.First"];     
  var stacks = function (dictUnsafeBronze) {
      return function ($11) {
          return (function (v) {
              return v.disasterStack;
          })(Age_Bronze.getBronzeState(dictUnsafeBronze)($11));
      };
  };
  var pop = function (dictUnsafeBronze) {
      return function ($12) {
          return (function (v) {
              return v.population;
          })(Age_Bronze.getBronzeState(dictUnsafeBronze)($12));
      };
  };
  var popOrStacks = function (state) {
      if (Age_Bronze.isSuffering(state)) {
          return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("disaster") ])([ Render_Side.sideLabel("Disaster stacks:"), Halogen_HTML.text(Types_Class.prettify(Types_Class.prettyInt)(Types_Age.unsafeBronze(function (dictUnsafeBronze) {
              return stacks(dictUnsafeBronze);
          })(state))) ]);
      };
      if (Prelude.otherwise) {
          return Halogen_HTML_Elements.div_([ Render_Side.sideLabel("Population:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyPopulation)(Types_Age.unsafeBronze(function (dictUnsafeBronze) {
              return pop(dictUnsafeBronze);
          })(state))) ]);
      };
      throw new Error("Failed pattern match at Age.Bronze.Render line 39, column 1 - line 40, column 1: " + [ state.constructor.name ]);
  };
  var partitionClass = function (n) {
      if (n <= 0) {
          return "";
      };
      if (n <= 33) {
          return " shake-little shake-constant";
      };
      if (n <= 66) {
          return " shake shake-constant";
      };
      if (Prelude.otherwise) {
          return " shake-hard shake-constant";
      };
      throw new Error("Failed pattern match at Age.Bronze.Render line 73, column 1 - line 74, column 1: " + [ n.constructor.name ]);
  };
  var sufferingClass = function (state) {
      var $9 = Data_Lens_Fold["^?"](state.ageState)(function ($13) {
          return Lenses.bronzeState(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_Maybe_First.monoidFirst)))(Lenses.bronzeStack(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($13));
      });
      if ($9 instanceof Data_Maybe.Just) {
          return partitionClass($9.value0);
      };
      if ($9 instanceof Data_Maybe.Nothing) {
          return "";
      };
      throw new Error("Failed pattern match at Age.Bronze.Render line 67, column 1 - line 68, column 1: " + [ $9.constructor.name ]);
  };
  var populationComponent = function (state) {
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("population" + sufferingClass(state)) ])([ Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyPopulation)(Types_Age.unsafeBronze(function (dictUnsafeBronze) {
          return pop(dictUnsafeBronze);
      })(state))) ]);
  };
  var side = function (state) {
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass(sufferingClass(state)) ])([ Halogen_HTML.text("Current clicks:"), Halogen_HTML_Elements.br_, Halogen_HTML_Elements_Indexed.span([ Util.mkClass("current-clicks bold") ])([ Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(state.currentClicks)) ]), Render_Side.sideLabel("Total clicks:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(state.totalClicks)), Halogen_HTML_Elements.br_, Render_Side.sideLabel("My click power:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(state.burst)), Halogen_HTML_Elements.br_, Render_Side.sideLabel("Tribal click power:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicksPerSecond)(state.cps)), Halogen_HTML_Elements.br_, popOrStacks(state), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.br_, Render_Side.theButton ]);
  };
  var upgradesComponent = function (state) {
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("upgrades" + sufferingClass(state)) ])([ Halogen_HTML.text("blah blah") ]);
  };
  var advanceComponent = function (state) {
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("advance" + sufferingClass(state)) ])([ Halogen_HTML.text("You're not sure what you need to do to advance.") ]);
  };
  exports["sufferingClass"] = sufferingClass;
...
})(PS["Age.Bronze.Render"] = PS["Age.Bronze.Render"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var upgradeName = function (v) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 48, column 1 - line 49, column 1: " + [ v.constructor.name ]);
  };
  var upgradeDescription = function (v) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 60, column 1 - line 61, column 1: " + [ v.constructor.name ]);
  };
  var upgradeCostModifier = function (n) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 39, column 1 - line 40, column 1: " + [ n.constructor.name ]);
  };
  ...
  var upgradeCost = function (v) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 24, column 1 - line 25, column 1: " + [ v.constructor.name ]);
  };
  var upgradeBoostModifier = function (n) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 104, column 1 - line 105, column 1: " + [ n.constructor.name ]);
  };
  var upgradeBoost = function (v) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 92, column 1 - line 93, column 1: " + [ v.constructor.name ]);
  };
  var recordPurchase = function (up) {
      return function (optic) {
          return function ($104) {
              return Data_Lens_Setter["-~"](Types_Numbers.ringClicks)(Lenses.currentClicks(Data_Profunctor_Strong.strongFn))(upgradeCost(up))(Data_Lens_Setter[".~"](function ($105) {
                  return Lenses.upgrades(Data_Profunctor_Strong.strongFn)(optic(Data_Profunctor_Strong.strongFn)($105));
              })(up)($104));
          };
      };
  };
  var nextUpgrade = function (v) {
      if (v instanceof Types_Upgrades.Misc1) {
          return new Types_Upgrades.Misc1(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Misc2) {
          return new Types_Upgrades.Misc2(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Tech1) {
          return new Types_Upgrades.Tech1(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Tech2) {
          return new Types_Upgrades.Tech2(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Phil1) {
          return new Types_Upgrades.Phil1(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Phil2) {
          return new Types_Upgrades.Phil2(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Poli1) {
          return new Types_Upgrades.Poli1(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Poli2) {
          return new Types_Upgrades.Poli2(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Science1) {
          return new Types_Upgrades.Science1(v.value0 + 1 | 0);
      };
      if (v instanceof Types_Upgrades.Science2) {
          return new Types_Upgrades.Science2(v.value0 + 1 | 0);
      };
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 72, column 1 - line 73, column 1: " + [ v.constructor.name ]);
  };
  ...
  var inflectionUpgradeMessage = function (up) {
      return upgradeName(up) + " cost down, boost up";
  };
  var canBuyUpgrade = function (state) {
      return function (optic) {
          var currUpgrade = Data_Lens_Getter["^."](state)(function ($106) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(optic(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($106));
          });
          ...
          return Prelude[">="](Types_Numbers.ordClicks)(currClicks)(nextCost);
      };
  };
  var buyUpgrade = function (v) {
      ...
      throw new Error("Failed pattern match at Age.Stone.Upgrades line 113, column 1 - line 114, column 1: " + [ v.constructor.name ]);
  };
  var makeUpgradedState = function (u) {
      var tech2arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Tech2.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($117) {
          return Lenses.tech2(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($117));
      })));
      var tech1arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Tech1.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($118) {
          return Lenses.tech1(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($118));
      })));
      var science2arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Science2.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($119) {
          return Lenses.science2(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($119));
      })));
      var science1arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Science1.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($120) {
          return Lenses.science1(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($120));
      })));
      var poli2arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Poli2.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($121) {
          return Lenses.poli2(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($121));
      })));
      var poli1arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Poli1.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($122) {
          return Lenses.poli1(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($122));
      })));
      var phil2arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Phil2.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($123) {
          return Lenses.phil2(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($123));
      })));
      var phil1arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Phil1.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($124) {
          return Lenses.phil1(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($124));
      })));
      var misc2arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Misc2.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($125) {
          return Lenses.misc2(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($125));
      })));
      var misc1arr = Prelude["<$>"](Prelude.functorArray)(Types_Upgrades.Misc1.create)(Util["..."](1)(Data_Lens_Getter["^."](u)(function ($126) {
          return Lenses.misc1(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($126));
      })));
  ...
  var cpsFromUpgrades = function ($127) {
      return Data_Lens_Getter.view(Lenses.cps(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(makeUpgradedState($127));
  };
  var burstFromUpgrades = function ($128) {
      return Data_Lens_Getter.view(Lenses.burst(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(makeUpgradedState($128));
  };
...
})(PS["Age.Stone.Upgrades"] = PS["Age.Stone.Upgrades"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Data_Lens = PS["Data.Lens"];
  var Data_Int = PS["Data.Int"];
  var Age_Stone_Upgrades = PS["Age.Stone.Upgrades"];
  var Data_Lens_Getter = PS["Data.Lens.Getter"];
  var Data_Profunctor_Star = PS["Data.Profunctor.Star"];
  var Data_Const = PS["Data.Const"];
  var Types_Upgrades = PS["Types.Upgrades"];     
  var perhalfcentAdvanced = function (state) {
      var lastClicks = Data_Lens_Getter["^."](state)(function ($2) {
          return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.science2(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($2)));
      });
      var firstClicks = Data_Lens_Getter["^."](state)(function ($3) {
          return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.misc1(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($3)));
      });
      var firstClickPart = (function () {
          var $0 = firstClicks >= 100;
          if ($0) {
              return 1.0;
          };
          if (!$0) {
              return Data_Int.toNumber(firstClicks) / 100.0;
          };
          throw new Error("Failed pattern match at Age.Stone.Advance line 14, column 1 - line 15, column 1: " + [ $0.constructor.name ]);
      })();
      var currClicks = Data_Lens_Getter["^."](state)(function ($4) {
          return Lenses.currentClicks(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.clicks(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($4));
      });
      var lastClickPart = (function () {
          var $1 = lastClicks >= 1 || currClicks >= Data_Lens_Getter["^."](Age_Stone_Upgrades.upgradeCost(new Types_Upgrades.Science2(1)))(Lenses.clicks(Data_Profunctor_Star.strongStar(Data_Const.functorConst)));
          if ($1) {
              return 1.0;
          };
          if (!$1) {
              return currClicks / Data_Lens_Getter["^."](Age_Stone_Upgrades.upgradeCost(new Types_Upgrades.Science2(1)))(Lenses.clicks(Data_Profunctor_Star.strongStar(Data_Const.functorConst)));
          };
          throw new Error("Failed pattern match at Age.Stone.Advance line 14, column 1 - line 15, column 1: " + [ $1.constructor.name ]);
      })();
      var n = Data_Int.round(25.0 * lastClickPart + 25.0 * firstClickPart);
      return n;
  };
  exports["perhalfcentAdvanced"] = perhalfcentAdvanced;;
 
})(PS["Age.Stone.Advance"] = PS["Age.Stone.Advance"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  var Types = PS["Types"];
  var Age_Stone_Upgrades = PS["Age.Stone.Upgrades"];
  var Age_Bronze_Upgrades = PS["Age.Bronze.Upgrades"];
  var Types_Age = PS["Types.Age"];     
  var cpsFromUpgrades = function (v) {
      if (v instanceof Types_Age.Stone) {
          return Age_Stone_Upgrades.cpsFromUpgrades;
      };
      return Age_Stone_Upgrades.cpsFromUpgrades;
  };
  var burstFromUpgrades = function (v) {
      if (v instanceof Types_Age.Stone) {
          return Age_Stone_Upgrades.burstFromUpgrades;
      };
      return Age_Stone_Upgrades.burstFromUpgrades;
  };
  exports["burstFromUpgrades"] = burstFromUpgrades;
...
(function(exports) {
  ...
  var Data_Profunctor_Star = PS["Data.Profunctor.Star"];
  var Data_Const = PS["Data.Const"];     
  var storageKeys = Prelude.map(Prelude.functorArray)(Util.scramble)([ "totalClicks", "currentClicks", "age", "upgrades", "now", "ageState" ]);
  ...
  var stateTuples = function (state) {
      var makeTuple = function (dictSerialize) {
          return function (key) {
              return function (v) {
                  return Data_Bifunctor.bimap(Data_Tuple.bifunctorTuple)(Util.scramble)(function ($28) {
                      return Util.scramble(Types_Class.serialize(dictSerialize)($28));
                  })(new Data_Tuple.Tuple(key, v));
              };
          };
      };
      return [ makeTuple(Types_Numbers.serializeClicks)("currentClicks")(state.currentClicks), makeTuple(Types_Numbers.serializeClicks)("totalClicks")(state.totalClicks), makeTuple(Types_Upgrades.serializeUpgrades)("upgrades")(state.upgrades), makeTuple(Types_Age.serializeAge)("age")(state.age), makeTuple(Types_Class.serializeMilliseconds)("now")(state.now), makeTuple(Types_Age.serializeAgeState)("ageState")(state.ageState) ];
  };
  ...
  var saveState = function ($29) {
      return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(saveSingleState)(stateTuples($29));
  };
  var parseUpgrades = (function () {
      var ups = function (dictContravariant) {
          return function (dictApplicative) {
              return Data_Foreign_Lens.getter(Data_Foreign_Class.read(Types_Upgrades.isForeignUpgrades))(dictContravariant)(dictApplicative);
          };
      };
      return function ($30) {
          return Data_Maybe.fromMaybe(Types.initialState.upgrades)(Data_Foreign_Lens.get(function (dictContravariant) {
              return function (dictApplicative) {
                  return function ($31) {
                      return Data_Foreign_Lens.json(dictContravariant)(dictApplicative)(ups(dictContravariant)(dictApplicative)($31));
                  };
              };
          })(Util.unscramble($30)));
      };
  ...
  var parseAge = (function () {
      var age = function (v) {
          if (v === "Stone") {
              return new Data_Either.Right(Types_Age.Stone.value);
          };
          if (v === "Bronze") {
              return new Data_Either.Right(Types_Age.Bronze.value);
          };
          if (v === "Iron") {
              return new Data_Either.Right(Types_Age.Iron.value);
          };
          if (v === "Classical") {
              return new Data_Either.Right(Types_Age.Classical.value);
          };
          if (v === "Dark") {
              return new Data_Either.Right(Types_Age.Dark.value);
          };
          if (v === "Medieval") {
              return new Data_Either.Right(Types_Age.Medieval.value);
          };
          if (v === "Renaissance") {
              return new Data_Either.Right(Types_Age.Renaissance.value);
          };
          if (v === "Imperial") {
              return new Data_Either.Right(Types_Age.Imperial.value);
          };
          if (v === "Industrial") {
              return new Data_Either.Right(Types_Age.Industrial.value);
          };
          if (v === "Nuclear") {
              return new Data_Either.Right(Types_Age.Nuclear.value);
          };
          if (v === "Information") {
              return new Data_Either.Right(Types_Age.Information.value);
          };
          if (v === "Global") {
              return new Data_Either.Right(Types_Age.Global.value);
          };
          if (v === "Space") {
              return new Data_Either.Right(Types_Age.Space.value);
          };
          if (v === "Solar") {
              return new Data_Either.Right(Types_Age.Solar.value);
          };
          return new Data_Either.Left(Prelude.unit);
      };
      return function ($32) {
          return Data_Maybe.fromMaybe(Types.initialState.age)(Data_Foreign_Lens.get(function (dictContravariant) {
              return function (dictApplicative) {
  ...
  var getNumber = function ($$default) {
      return function ($33) {
          return Data_Maybe.fromMaybe($$default)(Data_Foreign_Lens.get(function (dictContravariant) {
              return function (dictApplicative) {
                  return function ($34) {
                      return Data_Foreign_Lens.json(dictContravariant)(dictApplicative)(Data_Foreign_Lens.number(dictContravariant)(dictApplicative)($34));
                  };
              };
          })($33));
      };
  };
  var getScrambledNumber = function ($$default) {
      return function ($35) {
          return getNumber($$default)(Util.unscramble($35));
      };
  };
  var parseCurrentClicks = function ($36) {
      return Types_Numbers.Clicks(getScrambledNumber(Data_Lens_Getter["^."](Types.initialState)(Lenses.currentClicksNumber(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))($36));
  };
  var parseNow = function ($37) {
      return Data_Time.Milliseconds(getScrambledNumber(0)($37));
  };
  var parseTotalClicks = function ($38) {
      return Types_Numbers.Clicks(getScrambledNumber(Data_Lens_Getter["^."](Types.initialState)(Lenses.totalClicksNumber(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))($38));
  };
  var getInt = function ($$default) {
      return function ($39) {
          return Data_Maybe.fromMaybe($$default)(Data_Foreign_Lens.get(function (dictContravariant) {
              return function (dictApplicative) {
                  return function ($40) {
                      return Data_Foreign_Lens.json(dictContravariant)(dictApplicative)(Data_Foreign_Lens["int"](dictContravariant)(dictApplicative)($40));
                  };
              };
          })($39));
      };
  };
  var parseBronzeAgeState = function (v) {
      if (v === "") {
          return new Types_Age.BronzeS({
              population: 2.0, 
              disasterStack: 0, 
              stackRemoval: 1
          });
      };
      var arr = Data_String.split(",")(Util.unscramble(v));
      var disasterStack = getInt(0)(Data_Maybe.fromMaybe("0")(Data_Array["!!"](arr)(1)));
      var population = Types_Numbers.Population(getNumber(100.0)(Data_Maybe.fromMaybe("2.0")(Data_Array["!!"](arr)(0))));
      var stackRemoval = getInt(1)(Data_Maybe.fromMaybe("1")(Data_Array["!!"](arr)(2)));
      return new Types_Age.BronzeS({
          population: population, 
          disasterStack: disasterStack, 
          stackRemoval: stackRemoval
      });
  };
  var getAgeStateCode = function ($42) {
      return Data_Maybe.fromMaybe("")(Data_Tuple.lookup(Data_Foldable.foldableArray)(Prelude.eqString)(Util.scramble("ageState"))($42));
  };
  var getAgeState = function (a) {
      return function (xs) {
          var str = getAgeStateCode(xs);
          var as = (function () {
              if (a instanceof Types_Age.Bronze) {
                  return parseBronzeAgeState(str);
              };
              return Types_Age.NoAgeState.value;
          })();
          return as;
      };
  };
  var calculateTimeDifferential = function (delta) {
      return function (v) {
          ...
          var f = function (t) {
              ...
              throw new Error("Failed pattern match at Save line 141, column 1 - line 142, column 1: " + [ t.constructor.name ]);
          };
          return f(delta);
      };
  };
  var getSavedState = function __do() {
      var v = Prelude["<$>"](Control_Monad_Eff.functorEff)(function ($43) {
          return Data_Array.zip(storageKeys)(Data_Array.catMaybes($43));
      ...
      var _ageState = getAgeState(_age)(v);
      var _burst = Upgrades.burstFromUpgrades(_age)(_upgrades);
      var _cps = Upgrades.cpsFromUpgrades(_age)(_upgrades);
      var _cc = calculateTimeDifferential(Prelude["-"](Data_Time.ringMilliseconds)(_now)(v1))(_cps);
      Control_Monad_Eff_Console.print(Prelude.showNumber)(getScrambledNumber(2.0)("10.0"))();
      return {
          currentClicks: Prelude["+"](Types_Numbers.semiringClicks)(_currentClicks)(_cc), 
          totalClicks: Prelude["+"](Types_Numbers.semiringClicks)(_totalClicks)(_cc), 
          upgrades: _upgrades, 
          age: _age, 
          ageState: _ageState, 
...
(function(exports) {
  ...
  var Data_Profunctor_Choice = PS["Data.Profunctor.Choice"];
  var Types_Disaster = PS["Types.Disaster"];     
  var suffer = function (d) {
      return Data_Lens_Setter[".~"](function ($0) {
          return Lenses.ageState(Data_Profunctor_Strong.strongFn)(Lenses.bronzeState(Data_Profunctor_Choice.choiceFn)(Lenses.bronzeStack(Data_Profunctor_Strong.strongFn)($0)));
      })(100);
  };
  var earthquake = Types_Disaster.Disaster1.value;
  exports["earthquake"] = earthquake;
  exports["suffer"] = suffer;;
 
})(PS["Disaster.Bronze"] = PS["Disaster.Bronze"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Data_Time = PS["Data.Time"];
  var Age_Stone_Upgrades = PS["Age.Stone.Upgrades"];
  var Disaster_Bronze = PS["Disaster.Bronze"];
  var Data_Lens_Setter = PS["Data.Lens.Setter"];
  var Data_Profunctor_Strong = PS["Data.Profunctor.Strong"];
  var Data_Lens_Getter = PS["Data.Lens.Getter"];
  var Data_Profunctor_Star = PS["Data.Profunctor.Star"];
  ...
  var buyUpgrade = function (up) {
      return function (state) {
          if (Age_Stone_Upgrades.isInflectionUpgrade(up)) {
              return Age_Stone_Upgrades.buyUpgrade(up)(Data_Lens_Setter.set(Lenses.message(Data_Profunctor_Strong.strongFn))(Age_Stone_Upgrades.inflectionUpgradeMessage(up))(state));
          };
          if (Prelude.otherwise) {
              return Age_Stone_Upgrades.buyUpgrade(up)(Data_Lens_Setter.set(Lenses.message(Data_Profunctor_Strong.strongFn))("Upgraded " + Age_Stone_Upgrades.upgradeName(up))(state));
          };
          throw new Error("Failed pattern match at Age.Stone.Eval line 24, column 1 - line 25, column 1: " + [ up.constructor.name, state.constructor.name ]);
      };
  };
  var autoclick = function (ms) {
      return function (state) {
          var delta = Prelude["-"](Data_Time.ringMilliseconds)(ms)(state.now);
          var summand = Save.calculateTimeDifferential(delta)(state.cps);
          return Data_Lens_Setter["+~"](Types_Numbers.semiringClicks)(Lenses.currentClicks(Data_Profunctor_Strong.strongFn))(summand)(Data_Lens_Setter["+~"](Types_Numbers.semiringClicks)(Lenses.totalClicks(Data_Profunctor_Strong.strongFn))(summand)(Data_Lens_Setter[".~"](Lenses.now(Data_Profunctor_Strong.strongFn))(ms)(state)));
      };
  };
  var advance = function (state) {
      return Disaster_Bronze.suffer(Disaster_Bronze.earthquake)(Data_Lens_Setter.set(Lenses.ageState(Data_Profunctor_Strong.strongFn))(new Types_Age.BronzeS({
          population: 10.0, 
          disasterStack: 0, 
          stackRemoval: 1
      }))(Data_Lens_Setter.set(Lenses.age(Data_Profunctor_Strong.strongFn))(Age.nextAge(state.age))(Data_Lens_Setter.set(Lenses.currentClicks(Data_Profunctor_Strong.strongFn))(0.0)(state))));
  };
  exports["autoclick"] = autoclick;
  exports["advance"] = advance;
  exports["buyUpgrade"] = buyUpgrade;
...
})(PS["Age.Stone.Eval"] = PS["Age.Stone.Eval"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var sumUpgrades = function (u) {
      var g = function (acc) {
          return function (uplens) {
              return acc + Data_Lens_Getter["^."](u)(function ($1) {
                  return uplens(Lenses.viewLevel($1));
              }) | 0;
          };
      };
  ...
  var population = function (state) {
      if (state.age instanceof Types_Age.Stone) {
...
(function(exports) {
  ...
  var Render_Side = PS["Render.Side"];
  var Age_Stone_Upgrades = PS["Age.Stone.Upgrades"];
  var Age_Stone_Advance = PS["Age.Stone.Advance"];
  var Data_Lens = PS["Data.Lens"];
  var Data_String = PS["Data.String"];
  var Data_Array = PS["Data.Array"];
  var Halogen = PS["Halogen"];
      ...
      return function (state) {
          var hoverText = function (state1) {
              return function (uplens1) {
                  return [ Halogen_HTML_Properties_Indexed.title(Age_Stone_Upgrades.upgradeDescription(Data_Lens_Getter["^."](state1)(function ($14) {
                      return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(uplens1($14));
                  }))) ];
              };
          };
          var clickAction = Halogen_HTML_Events_Indexed.onMouseDown(Halogen_HTML_Events.input_(Types.Buy.create(Age_Stone_Upgrades.nextUpgrade(Data_Lens_Getter["^."](state)(function ($15) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(uplens(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($15));
          })))));
          return Prelude["++"](Prelude.semigroupArray)(hoverText(state)(uplens(Data_Profunctor_Star.strongStar(Data_Const.functorConst))))((function () {
              var $12 = Age_Stone_Upgrades.canBuyUpgrade(state)(function (dictStrong) {
              ...
              throw new Error("Failed pattern match at Age.Stone.Render line 72, column 1 - line 73, column 1: " + [ $12.constructor.name ]);
          })());
      };
  };
  var upgradeButton = function (uplens) {
      return function (state) {
          return Halogen_HTML_Elements_Indexed.div(upgradeProps(function (dictStrong) {
              return uplens(dictStrong);
          })(state))([ Halogen_HTML_Elements_Indexed.div([ Util.mkClass("name") ])([ Halogen_HTML.text(Age_Stone_Upgrades.upgradeName(Data_Lens_Getter["^."](state)(function ($16) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(uplens(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($16));
          }))), Halogen_HTML_Elements_Indexed.span([ Util.mkClass("level") ])([ Halogen_HTML.text(" " + Prelude.show(Prelude.showInt)(Data_Lens_Getter["^."](state)(function ($17) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(uplens(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(Lenses.viewLevel($17)));
          }))) ]) ]), Halogen_HTML_Elements_Indexed.div([ Util.mkClass("cost") ])([ Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(Age_Stone_Upgrades.upgradeCost(Age_Stone_Upgrades.nextUpgrade(Data_Lens_Getter["^."](state)(function ($18) {
              return Lenses.upgrades(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(uplens(Data_Profunctor_Star.strongStar(Data_Const.functorConst))($18));
          }))))) ]) ]);
      };
  };
  var upgradesComponent = function (state) {
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("upgrades") ])([ upgradeButton(function (dictStrong) {
          return Lenses.misc1(dictStrong);
  ...
  var side = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML.text("Current clicks:"), Halogen_HTML_Elements.br_, Halogen_HTML_Elements_Indexed.span([ Util.mkClass("current-clicks bold") ])([ Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(state.currentClicks)) ]), Render_Side.sideLabel("Total clicks:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(state.totalClicks)), Halogen_HTML_Elements.br_, Render_Side.sideLabel("My click power:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicks)(state.burst)), Halogen_HTML_Elements.br_, Render_Side.sideLabel("Tribal click power:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyClicksPerSecond)(state.cps)), Halogen_HTML_Elements.br_, Render_Side.sideLabel("Population:"), Halogen_HTML.text(Types_Class.prettify(Types_Numbers.prettyPopulation)(Population.population(state))), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.br_, Render_Side.theButton ]);
  };
  var showAdvanceButton = function (extraClass) {
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("advanceButton" + extraClass) ])([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_(Types.Advance.create)) ])([ Halogen_HTML.text("Advance") ]) ]);
  };
  var advanceComponent = function (state) {
      var l = Age_Stone_Advance.perhalfcentAdvanced(state);
      var unfilledBars = Data_String.fromCharArray(Data_Array.replicate(50 - l)("|"));
      var filledBars = Data_String.fromCharArray(Data_Array.replicate(l)("|"));
      var extraClass = (function () {
          ...
          throw new Error("Failed pattern match at Age.Stone.Render line 83, column 1 - line 84, column 1: " + [ $13.constructor.name ]);
      })();
      return Halogen_HTML_Elements_Indexed.div([ Util.mkClass("viewAdvance") ])([ Halogen_HTML_Elements_Indexed.span([ Util.mkClass("dropCap") ])([ Halogen_HTML.text("You must discover how to smelt bronze and attain enough\n    language proficiency. The following shows a rough estimate of how close you\n    are to advancing to the next age:") ]), Halogen_HTML_Elements_Indexed.p([ Util.mkClass("advanceBar") ])([ Halogen_HTML.text("0 "), Halogen_HTML_Elements_Indexed.span([ Util.mkClass("advance filled") ])([ Halogen_HTML.text(filledBars) ]), Halogen_HTML_Elements_Indexed.span([ Util.mkClass("advance unfilled") ])([ Halogen_HTML.text(unfilledBars) ]), Halogen_HTML.text(" 100") ]), showAdvanceButton(extraClass), Halogen_HTML_Elements.p_([ Halogen_HTML.text("Warning: advancing a culture is never easy. Be prepared with your\n         clicking finger ... ") ]) ]);
  };
  exports["advanceComponent"] = advanceComponent;
  exports["upgradesComponent"] = upgradesComponent;
  exports["side"] = side;;
 
})(PS["Age.Stone.Render"] = PS["Age.Stone.Render"] || {});
(function(exports) {
  /* global exports */
  "use strict";
...
(function(exports) {
  ...
  var Halogen_HTML_Events_Indexed = PS["Halogen.HTML.Events.Indexed"];
  var Halogen_HTML_Properties_Indexed = PS["Halogen.HTML.Properties.Indexed"];
  var Age_Stone_Render = PS["Age.Stone.Render"];
  var Age_Stone_Eval = PS["Age.Stone.Eval"];
  var Age_Bronze_Eval = PS["Age.Bronze.Eval"];
  var Age_Bronze_Render = PS["Age.Bronze.Render"];
  var Disaster_Bronze = PS["Disaster.Bronze"];
  var Types_Age = PS["Types.Age"];
  var Halogen_HTML_Elements = PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Elements_Indexed = PS["Halogen.HTML.Elements.Indexed"];
  ...
  var viewSide = function (state) {
      if (state.age instanceof Types_Age.Stone) {
          return Age_Stone_Render.side(state);
      };
      if (state.age instanceof Types_Age.Bronze) {
          return Age_Bronze_Render.side(state);
      };
      return Age_Stone_Render.side(state);
  };
  var upgradesComponent = function (state) {
      if (state.age instanceof Types_Age.Stone) {
          return Age_Stone_Render.upgradesComponent(state);
      };
      if (state.age instanceof Types_Age.Bronze) {
          return Age_Bronze_Render.upgradesComponent(state);
      };
      return Age_Stone_Render.upgradesComponent(state);
  };
  ...
  var populationComponent = function (state) {
      if (state.age instanceof Types_Age.Bronze) {
          return Age_Bronze_Render.populationComponent(state);
      };
  ...
  var $$eval = function (v) {
      if (v instanceof Types.Click) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(v.value0)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.get)(function (v1) {
              return Halogen_Query.modify((function () {
                  if (v1.age instanceof Types_Age.Stone) {
                      return Age_Stone_Eval.evalClick;
                  };
                  if (v1.age instanceof Types_Age.Bronze) {
                      return Age_Bronze_Eval.evalClick;
                  };
                  return Age_Stone_Eval.evalClick;
              })());
          }));
      ...
      if (v instanceof Types.Buy) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(v.value1)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(Data_Lens_Setter.set(Lenses.message(Data_Profunctor_Strong.strongFn))("")))(function () {
              return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query["liftAff'"](Control_Monad_Aff_Class.monadAffAff)(Control_Monad_Aff.later(Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.unit))))(function () {
                  return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.get)(function (v1) {
                      return Halogen_Query.modify((function () {
                          if (v1.age instanceof Types_Age.Stone) {
                              return Age_Stone_Eval.buyUpgrade(v.value0);
                          };
                          return Age_Stone_Eval.buyUpgrade(v.value0);
                      })());
                  });
      ...
      if (v instanceof Types.Suffer) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(v.value1)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(function (v1) {
              return v1.age;
          }))(function (v1) {
              return Halogen_Query.modify((function () {
                  if (v1 instanceof Types_Age.Bronze) {
                      return Disaster_Bronze.suffer(v.value0);
                  };
      ...
      if (v instanceof Types.Autoclick) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(v.value0)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(function (v1) {
              ...
              return Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query["liftEff'"](Control_Monad_Aff.monadEffAff)(Data_Date.nowEpochMilliseconds))(function (v2) {
                  return Halogen_Query.modify((function () {
                      if (v1 instanceof Types_Age.Stone) {
                          return Age_Stone_Eval.autoclick(v2);
                      };
                      if (v1 instanceof Types_Age.Bronze) {
                          return Age_Bronze_Eval.autoclick(v2);
                      };
                      return Age_Stone_Eval.autoclick(v2);
                  })());
              });
      ...
      if (v instanceof Types.View) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(v.value1)(Halogen_Query.modify(Data_Lens_Setter.set(Lenses.tab(Data_Profunctor_Strong.strongFn))(v.value0)));
      };
      if (v instanceof Types.Advance) {
          return Data_Functor["<$"](Control_Monad_Free.freeFunctor)(v.value0)(Prelude.bind(Control_Monad_Free.freeBind)(Halogen_Query.gets(function (v1) {
              return v1.age;
          }))(function (v1) {
              return Halogen_Query.modify((function () {
                  if (v1 instanceof Types_Age.Stone) {
                      return Age_Stone_Eval.advance;
                  };
                  return Age_Stone_Eval.advance;
              })());
          }));
      };
      throw new Error("Failed pattern match at Main line 199, column 1 - line 200, column 1: " + [ v.constructor.name ]);
  };
  var divider = Halogen_HTML_Elements_Indexed.span([ Util.mkClass("divide") ])([ Halogen_HTML.text(" | ") ]);
  var unlockViewTabs = function (state) {
      var tabByAge = function (v) {
          if (v instanceof Types_Age.Stone) {
              return [  ];
          };
          if (v instanceof Types_Age.Bronze) {
              return [ divider, Halogen_HTML_Elements_Indexed.span([ Util.mkClass("tab"), Halogen_HTML_Events_Indexed.onMouseDown(Halogen_HTML_Events.input_(Types.View.create(Types.PopulationTab.value))) ])([ Halogen_HTML.text(Prelude.show(Types.showView)(Types.PopulationTab.value)) ]) ];
          };
          return Prelude["++"](Prelude.semigroupArray)(tabByAge(Types_Age.Bronze.value))([ divider, Halogen_HTML_Elements_Indexed.span([ Util.mkClass("tab") ])([ Halogen_HTML.text(Prelude.show(Types.showView)(Types.TechTreeTab.value)) ]) ]);
      };
  ...
  var advanceComponent = function (state) {
      if (state.age instanceof Types_Age.Stone) {
          return Age_Stone_Render.advanceComponent(state);
      };
      if (state.age instanceof Types_Age.Bronze) {
          return Age_Bronze_Render.advanceComponent(state);
      };
      return Age_Stone_Render.advanceComponent(state);
  };
  var viewTabs = function (state) {
      ...
      throw new Error("Failed pattern match at Main line 154, column 1 - line 155, column 1: " + [ state.view.constructor.name ]);
  };
  var adjustBody = function (state) {
      if (state.age instanceof Types_Age.Stone) {
          return "";
      };
      if (state.age instanceof Types_Age.Bronze) {
          return Age_Bronze_Render.sufferingClass(state);
      };
      return "";
  };
  var render = function (state) {
      var top = Halogen_HTML_Elements_Indexed.h1([ Halogen_HTML_Properties_Indexed.id_("title") ])([ Halogen_HTML.text("clicker builder: the "), Halogen_HTML_Elements_Indexed.span([ Util.mkClass(Prelude.show(Types_Age.ageShow)(state.age)) ])([ Halogen_HTML.text(Prelude.show(Types_Age.ageShow)(state.age)) ]), Halogen_HTML.text(" Age.") ]);
      var side = Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.id_("side") ])([ viewSide(state), Halogen_HTML_Elements.br_, Halogen_HTML_Elements_Indexed.span([ Halogen_HTML_Events_Indexed.onMouseDown(Halogen_HTML_Events.input_(Types.Save.create)), Util.mkClass("button") ])([ Halogen_HTML.text("Save") ]), divider, Halogen_HTML_Elements_Indexed.span([ Halogen_HTML_Events_Indexed.onMouseDown(Halogen_HTML_Events.input_(Types.Reset.create)), Util.mkClass("button") ])([ Halogen_HTML.text("Reset") ]) ]);
      var main$prime = Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.id_("main") ])([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.id_("view") ])([ unlockViewTabs(state), viewTabs(state) ]), (function () {
          var $48 = Data_String["null"](state.message);
          if ($48) {
  ...
  var main = Control_Monad_Aff.runAff(Control_Monad_Eff_Exception.throwException)(Prelude["const"](Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit)))(Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Save.getSavedState))(function (v) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Halogen_Driver.runUI($$interface)(v))(function (v1) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Halogen_Util.onLoad(Control_Monad_Aff.monadEffAff)(Halogen_Util.appendToBody(Control_Monad_Eff_Class.monadEffEff)(v1.node)))(function () {
              return Util.schedule([ Data_Tuple.Tuple.create(100)(v1.driver(Halogen_Query.action(Types.Autoclick.create))) ]);
          });
      });
  }));
  exports["main"] = main;
  ...
  exports["viewSide"] = viewSide;
  exports["adjustBody"] = adjustBody;
